        ...
        if (GUILayout.Button("Karten einlesen"))
        {
            foreach(UnityEngine.Object o in Selection.objects)
            {
                ...
                if (sprite!=null)
                {
                    ...
                    if (n.IndexOf("spades")>-1  || n.IndexOf("yellow") > -1)
                    {
                        karte.Farbe = 1;
                    }
                    else if (n.IndexOf("clubs") > -1 || n.IndexOf("red") > -1)
                    {
                        karte.Farbe = 2;
                    }
                    else if (n.IndexOf("hearts") > -1 || n.IndexOf("green") > -1)
                    {
                        karte.Farbe = 13;
                    }
                    else if (n.IndexOf("diamonds") > -1 || n.IndexOf("blue") > -1)
                    {
                        karte.Farbe = 14;
                    }
